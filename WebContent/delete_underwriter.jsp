...
<%}
  ...
  <!-- Delete Underwriter Content -->
  <div class="container">
    <h2>Delete Underwriter</h2>
    <form action="<%=request.getContextPath()%>/admin_app/deleteUnderwriter" method="POST">
    ...
    if(request.getAttribute("res") != null){
      ...
      <p id="error-message" class="message error-message"><%=failure %></p>
      <p id="success-message" class="message success-message"><%=success %></p>
  </div>
