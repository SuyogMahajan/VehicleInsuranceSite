...
<%}
  ...
  <div class="container">
    ...
    <!-- Admin Actions -->
    <div class="actions">
      <a href="<%=request.getContextPath()%>/admin_app/insertUnderWriter">Register New Underwriter</a>
      <a href="<%=request.getContextPath()%>/admin_app/searchUnderWriter">Search Underwriter by ID</a>
      <a href="<%=request.getContextPath()%>/admin_app/updateUnderWriter">Update Underwriter Password</a>
      <a href="<%=request.getContextPath()%>/admin_app/deleteUnderwriter">Delete Underwriter</a>
      <a href="<%=request.getContextPath()%>/admin_app/viewAllUnderwriters">View All Underwriters</a>
      <a href="<%=request.getContextPath()%>/admin_app/viewUnderwriterVehicles">View All Vehicles for Specific Underwriter</a>
    </div>
  </div>
