...
<%}
  ...
  <!-- Header -->
  <header>
    <div class="logo">Star Protect Insurance - Renewal of Policy</div>
    <nav>
  ...
  <div class="container">
    ...
    <form action="<%=request.getContextPath()%>/underwriter_app/renewInsurance" method="post">
     <%
		if(request.getAttribute("Ins") == null) {
		%>
      <div class="form-group">
        <label for="policy-id">Enter Policy ID</label>
	  ...
	  <div class="form-group">
        <label for="policy-id">Enter Policy ID</label>
        <input type="text" id="policy-id" name="policy-id" value=<%=ins.getPolicyNo()%> readonly="readonly">
      </div>
      <%} %>
      <div id="policy-details" class="form-group" style="">
        ...
        <div class="buttons">
          <button id="renew-button" type="submit">Renewal</button>
      ...
      <div id="confirmation" class="form-group" style="">
        <h4 id="premium-amount"> Amount to be paid for renewal : 100</h4>
        <div class="buttons">
        
          <button id="confirm-renewal-button" type="submit" name="confirm-renewal" value="confirm-renewal">Ok</button>
          <button id="cancel-renewal-button">Cancel</button>
