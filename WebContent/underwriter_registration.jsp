...
header nav a, footer a {
    ...
    .container {
      width: 90%;
      max-width: 600px;
      margin: 40px auto; /* increased margin top and bottom */
    ...
    form input[type="text"], form input[type="date"], form input[type="password"] {
      width: calc(100% - 20px); /* subtract 20px from full width */
...
<%}
  ...
  <div class="container">
    ...
    <form action="<%=request.getContextPath()%>/admin_app/insertUnderWriter" method="POST">
      <label for="underwriter-id">Underwriter ID</label>
      <input type="text" id="underwriter-id" name="underwriter-id" value="UW1234" readonly>
      ...
      <input type="date" id="joining-date" name="doj" required>
<!-- 
      <label for="password">Default Password</label>
      <input type="password" id="password" name="password" required>
 -->
      <input type="submit" value="Register Underwriter">
    </form>
  </div>
